# 概念关系说明：Agent、LLM Context 与 Skill

> **文档类型**: 知识关系图谱 | **生成日期**: 2026-09-04
> **涉及概念**: Agent（智能体）、LLM Context（上下文）、Skill（技能模块）

---

## 📖 一、核心观点概述

**Agent、Context 和 Skill 三者构成了现代 AI 助手系统的核心架构三角**：
